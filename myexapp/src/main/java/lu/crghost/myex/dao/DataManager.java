...
public class DataManager {
    ...
    private static final String KEY = "gruntz4711";
    ...
    public DataManager(Context context) {
        ...
        db = openHelper.getWritableDatabase(KEY);
    ...
    private void openDb() {
        if (!db.isOpen()) {
            db = SQLiteDatabase.openDatabase(MyExProperties.DATABASE_PATH,KEY, null, SQLiteDatabase.OPEN_READWRITE);
